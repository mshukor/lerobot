...
#SBATCH --job-name=lerobot_smolvla_test_so101_doctest42_main
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH --mail-type=END,FAIL
#SBATCH --output=/lustre/fswork/projects/rech/dyf/ugz83ue/logs/slurm/lerobot_smolvla_test_so101_doctest42_main.out
...
# V3 So100
REPO_ID=imstevenpmwork/doctest42
DATASET_NAME=so101_doctest42
...
TASK_NAME=lerobot_${DATASET_NAME}_${POLICY_NAME}_so101
...
# TASK_NAME=lerobot_${DATASET_NAME}_${POLICY_NAME}_pretrained__so101
# TRAIN_DIR=$WORK/logs/lerobot/$TASK_NAME
# echo $TRAIN_DIR
# rm -r $TRAIN_DIR
